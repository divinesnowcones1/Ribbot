...
for ii = 1:length(x)
    ...
    joint1d = subs(joint1,[l1 l2 l3 l4m1 l4m2 l5m1 l5m2 l6], L);
    joint2d = subs(joint2,[l1 l2 l3 l4m1 l4m2 l5m1 l5m2 l6], L);
    joint3d = subs(joint3,[l1 l2 l3 l4m1 l4m2 l5m1 l5m2 l6], L);
    joint4d = subs(joint4,[l1 l2 l3 l4m1 l4m2 l5m1 l5m2 l6], L);
    joint5d = subs(joint5,[l1 l2 l3 l4m1 l4m2 l5m1 l5m2 l6], L);
    joint6d = subs(joint6,[l1 l2 l3 l4m1 l4m2 l5m1 l5m2 l6], L);

    delete(manipulator);
%     delete(endeffector);
    delete(floor);
    floor = line([xmin,xmax],[0,0],'Color',[0;0;0]);
    manipulator = line([joint1d(1), joint2d(1), joint3d(1), joint4d(1,:), joint5d(1), joint6d(1)], [joint1d(2), joint2d(2), joint3d(2), joint4d(2,:), joint5d(2), joint6d(2)], 'Color', [0;0;0],'LineStyle','-');
%   endeffector = line(joint2(1), joint2(2), 'Color', [1;0;0],'Marker','.', 'MarkerSize', 20);
    addpoints(h,gpo(1,4), gpo(2,4));
